  ...
  */
  public function materiales(){
    return $this->belongsToMany('App\Material', 'material_parte')
                ->withPivot('id', 'parte_id', 'proveedor_id', 'unidades', 'largo', 'ancho', 'alto', 'm2', 'total_m2', 'm3', 'total_m3', 'descuento', 'precio_total')
  ...
  public function materialespartes(){
    return $this->belongsToMany('App\Material', 'material_parte')
    ->withPivot('id', 'parte_id', 'material_id', 'proveedor_id', 'unidades', 'largo', 'ancho', 'alto', 'm2', 'total_m2', 'm3', 'total_m3', 'descuento', 'precio_total');
  }
