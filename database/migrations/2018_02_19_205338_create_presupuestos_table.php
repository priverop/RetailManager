...
class CreatePresupuestosTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('presupuestos', function (Blueprint $table) {
            ...
            $table->integer('maquinas_total')->default(0);
            ...
            $table->integer('bancos_total')->default(0);
            ...
            $table->integer('maquinas_oficial_1_total')->default(0);
            ...
            $table->integer('producto_ter_1_total')->default(0);
            ...
            $table->integer('productor_ter_2_total')->default(0);
            ...
            $table->integer('oficial_1_total')->default(0);
            ...
            $table->integer('oficial_2_total')->default(0);
            ...
            $table->integer('ayudante_total')->default(0);



            $table->integer('desplazamiento_unidad')->default(0);
            $table->integer('desplazamiento_total')->default(0);
            $table->integer('transporte_unidad')->default(0);
            $table->integer('transporte_total')->default(0);
            $table->integer('imprevistos_unidad')->default(0);
            $table->integer('imprevistos_total')->default(0);
            $table->timestamps();
        });
    }
